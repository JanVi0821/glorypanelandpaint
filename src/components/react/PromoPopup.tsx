...
export default function PromoPopup() {
  ...
  return (
    <div className="glory-promo" role="presentation">
      <div
        className="glory-promo__backdrop"
        onClick={close}
        aria-hidden="true"
      />
      <div
      ...
      >
        <button
          ...
          onClick={() => {
            window.posthog?.capture("promo_popup_dismissed");
            close();
          }}
          aria-label="Close"
        >
        ...
        <a
          className="glory-btn-gold glory-promo__cta"
          href={promo.ctaHref}
          onClick={() => {
            window.posthog?.capture("promo_popup_cta_clicked");
            close();
          }}
        >
          {promo.ctaLabel}
